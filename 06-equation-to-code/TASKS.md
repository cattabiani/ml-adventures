...
- Configure QLoRA parameters (4-bit quantization, rank, alpha, target modules) [x]
- Write the training script using Hugging Face `SFTTrainer` or a custom PyTorch loop [x]
